    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mt-10 space-y-16 border-t border-gray-200 pt-10 p-2">
                <!-- Component Start -->
                <x-secondary-button type="button" class="mt-2" wire:click="addColumn">
                    {{ __('Add Column') }}
                </x-secondary-button>
                        ...
                        @foreach($board->columns as $column)
                            <div class="flex flex-col flex-shrink-0 w-72">
                                <div class="flex items-center flex-shrink-0 h-10 px-2">
                                   <x-danger-button class="btn btn-sm " wire:click="deleteColumn('{{$column->id}}')" wire:confirm="Are you sure you want to delete this column?">-</x-danger-button>
                                    ...
                                    <button wire:click="addTask('{{$column->id}}')"  class="flex items-center justify-center w-6 h-6 ml-auto text-indigo-500 rounded hover:bg-indigo-500 hover:text-indigo-100">
                                ...
                                <div class="flex flex-col pb-2 overflow-auto">
                                    ...
                                    <div class="relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100" draggable="true">
                                        ...
                                        <div class="flex items-center w-full mt-3 text-xs font-medium text-gray-400">
                                            ...
                                            <img class="w-6 h-6 ml-auto rounded-full" src='https://randomuser.me/api/portraits/women/{{auth()->user()->id}}.jpg'/>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
